...
const ROOMS = [
  { id: "DELUXE", name: "Deluxe Room", description: "Elegant comfort with modern interiors & city views.", pricePerNight: 45000, image: deluxeImg, features: ["King Bed", "Ocean View", "Wi-Fi", "Breakfast"] },
  { id: "OCEAN", name: "Premier Ocean View", description: "Breathtaking ocean views with premium furnishings.", pricePerNight: 65000, image: oceanImg, features: ["King Bed", "Ocean View", "Wi-Fi", "Breakfast"] },
  { id: "EXECUTIVE", name: "Executive Suite", description: "Spacious luxury suite for refined stays.", pricePerNight: 90000, image: executiveImg, features: ["King Bed", "Ocean View", "Wi-Fi", "Breakfast"] },
  { id: "PRESIDENTIAL", name: "Presidential Suite", description: "Ultimate luxury with panoramic ocean views.", pricePerNight: 150000, image: presidentialImg, features: ["King Bed", "Ocean View", "Wi-Fi", "Breakfast"] },
];
...
export default function Rooms() {
  ...
  const handleBookNow = async (room) => {
    ...
    try {
      ...
      console.log(err);
      alert(err?.response?.data?.message || err.message || "Checkout initialization failed");
    }
  };
      ...
      <div className="searchBar">
        ...
        <div className="searchField">
          ...
          <select value={guests} onChange={(e) => setGuests(Number(e.target.value))}>
            {[1,2].map(n => <option key={n} value={n}>{n} Guest{n>1?'s':''}</option>)}
          </select>
        </div>
